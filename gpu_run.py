...
class Config:
    ...
    JOBS = {
        "walker_stand_noss_noise2net_seed0" : "python3 src/train.py \
                --domain_name walker \
                --task_name stand \
                --action_repeat 4 \
                --mode train \
                --num_shared_layers 8 \
                --seed 0 \
                --work_dir logs/walker_stand/no_ss/noise2net_seed0 \
                --save_model \
                --neural_aug_type=noise2net",
        
        "walker_stand_noss_noise2net_seed1" : "python3 src/train.py \
                --domain_name walker \
                --task_name stand \
                --action_repeat 4 \
                --mode train \
                --num_shared_layers 8 \
                --seed 1 \
                --work_dir logs/walker_stand/no_ss/noise2net_seed1 \
                --save_model \
                --neural_aug_type=noise2net",
        
        "walker_stand_noss_noise2net_seed2" : "python3 src/train.py \
                --domain_name walker \
                --task_name stand \
                --action_repeat 4 \
                --mode train \
                --num_shared_layers 8 \
                --seed 2 \
                --work_dir logs/walker_stand/no_ss/noise2net_seed2 \
                --save_model \
                --neural_aug_type=noise2net",
        
        "walker_stand_noss_noise2net_seed3" : "python3 src/train.py \
                --domain_name walker \
                --task_name stand \
                --action_repeat 4 \
                --mode train \
                --num_shared_layers 8 \
                --seed 3 \
                --work_dir logs/walker_stand/no_ss/noise2net_seed3 \
                --save_model \
                --neural_aug_type=noise2net",
    }
