...
class Config:
    ...
    JOBS = {
        "walker_walk_noss_noise2net_seed0_replayBuffer500k" : "python3 src/train.py \
                --domain_name walker \
                --task_name stand \
                --action_repeat 4 \
                --mode train \
                --num_shared_layers 8 \
                --seed 0 \
                --work_dir logs/walker_walk/no_ss/noise2net_seed0_replayBuffer500k \
                --save_model \
                --neural_aug_type=noise2net",
        
        # "walker_walk_noss_noise2net_seed1_replayBuffer500k" : "python3 src/train.py \
        #         --domain_name walker \
        #         --task_name walk \
        #         --action_repeat 4 \
        #         --mode train \
        #         --num_shared_layers 8 \
        #         --seed 1 \
        #         --work_dir logs/walker_walk/no_ss/noise2net_seed1_replayBuffer500k \
        #         --save_model \
        #         --neural_aug_type=noise2net",
    }
